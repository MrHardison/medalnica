...
export default {
  ...
  */
  head: {
    ...
    title: 'Медальница – витрина твоих беговых достижений.' || process.env.npm_package_name,
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { hid: 'description', name: 'description', content: 'Витрина твоих беговых достижений. Принимай участие в разных забегах. Собирай результаты и медали в одном месте.' || process.env.npm_package_description },
      { property: 'og:url', content: 'https://mymedals.ru' },
      ...
      { property: 'og:image', content: 'https://mymedals.ru/share.png' },
